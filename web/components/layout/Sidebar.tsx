...
const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      {
        href: '/pipeline',
        label: { en: 'Pipeline', ar: 'خط المبيعات' },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      },
      {
        ...
        label: { en: 'Msg Templates', ar: 'قوالب الرسائل' },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {
        href: '/email-history',
        label: { en: 'Email History', ar: 'سجل الإيميل' },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/tenants',
        label: { en: 'Tenants', ar: 'المستأجرون' },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {
        href: '/leases',
        label: { en: 'Leases', ar: 'عقود الإيجار' },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {
        href: '/renewal-templates',
        label: { en: 'Renewal Tmpls', ar: 'قوالب التجديد' },
        adminOnly: true,
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {
        href: '/inspections',
        label: { en: 'Inspections', ar: 'الفحوصات' },
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
